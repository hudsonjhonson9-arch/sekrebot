...
async function simapoSubmitPinjam() {
  ...
  try {
    ...
    console.error('[SIMAPO] Gagal kirim pengajuan:', e);
    showToast('Gagal mengirim pengajuan. Periksa koneksi server.', 'error');
  }
}
...
async function simapoSubmitTiket() {
  ...
  try {
    ...
    console.error('[SIMAPO] Gagal kirim laporan:', e);
    showToast('Gagal mengirim laporan. Periksa koneksi server.', 'error');
  }
}
